...
Route::get('/classview/{id}', [ClassController::class, 'classview'])->name('classroom.classview');
...
Route::get('/blog/summernote/{code}', [ClassController::class, 'summernote'])->name('blog.summernote');
